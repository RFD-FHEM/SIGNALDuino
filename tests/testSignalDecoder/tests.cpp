...
namespace arduino { namespace test
{
	...
	void Tests::TearDown()
	{
	  ...
	  TEST_F(Tests, msNCWS)
	  {
		...
		std::string base = "MS;P0=-3886;P1=481;P2=-1938;P3=-9200;D=13121012101010101010121012101212121212121210101212121012121212101010101212;CP=1;SP=3;R=0;O;m2;";
	...
	TEST_F(Tests, mcOSV11)
	{
			...
			std::string dstr = "MU;P0=-32001;P1=1673;P2=-1260;P3=-4304;P4=5712;P5=-6752;P6=3145;P7=-2718;D=12121212121212121212121345126712671212121267621712121212121212121212621712126;CP=1;R=245;";
